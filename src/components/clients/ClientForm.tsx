...
export default function ClientForm({ onClose, onClientAdded, onClientUpdated, client, mode = 'create' }: ClientFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(`Une erreur est survenue lors de ${mode === 'create' ? 'l\'ajout' : 'la modification'} du client`);
    } finally {
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e) => setFormData({ ...formData, needs_reminder: e.target.checked })}
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
              />
              <label htmlFor="needs_reminder" className="ml-2 block text-sm text-gray-700">
