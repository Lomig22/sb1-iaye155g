...
export default function ReminderSettingsModal({ client, onClose }: ReminderSettingsModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.reminder_delay_1 >= formData.reminder_delay_2 ||
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, reminder_delay_1: parseInt(e.target.value) })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, reminder_delay_2: parseInt(e.target.value) })}
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, reminder_delay_3: parseInt(e.target.value) })}
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, reminder_delay_final: parseInt(e.target.value) })}
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, reminder_template_1: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Utilisez {company}, {amount}, {invoice_number}, {due_date}, {days_late} comme variables"
                  />
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, reminder_template_1: getTemplateExample(1) })}
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, reminder_template_2: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Utilisez {company}, {amount}, {invoice_number}, {due_date}, {days_late} comme variables"
                  />
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, reminder_template_2: getTemplateExample(2) })}
                    className="absolute right-2 bottom-2 text-sm text-blue-600 hover:text-blue-800"
                  >
                    Utiliser un exemple
                  </button>
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, reminder_template_3: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Utilisez {company}, {amount}, {invoice_number}, {due_date}, {days_late} comme variables"
                  />
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, reminder_template_3: getTemplateExample(3) })}
                    className="absolute right-2 bottom-2 text-sm text-blue-600 hover:text-blue-800"
                  >
                    Utiliser un exemple
                  </button>
              ...
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={(e) => setFormData({ ...formData, reminder_template_final: e.target.value })}
                    className="w-full p-3 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Utilisez {company}, {amount}, {invoice_number}, {due_date}, {days_late} comme variables"
                  />
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, reminder_template_final: getTemplateExample(4) })}
                    className="absolute right-2 bottom-2 text-sm text-blue-600 hover:text-blue-800"
                  >
                    Utiliser un exemple
                  </button>
