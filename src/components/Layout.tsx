...
import { TrendingUp, Users, FileText, Settings, LogOut, X, Home } from 'lucide-react';
...
export default function Layout() {
  ...
  const handleLogout = async () => {
    try {
      ...
      setLogoutError("Une erreur est survenue lors de la déconnexion. Veuillez réessayer.");
    } finally {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg">
        <Link to="/" className="flex items-center h-16 px-4 border-b border-gray-200">
          ...
          <span className="ml-2 text-xl font-bold text-gray-900">PaymentFlow</span>
        </Link>
